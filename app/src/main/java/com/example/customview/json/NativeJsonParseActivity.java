package com.example.customview.json;
...
import com.example.customview.json.bean.DataInfo;
import com.example.customview.json.bean.FilmInfo;
import com.example.customview.json.bean.ShopInfo;
...
public class NativeJsonParseActivity extends Activity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        tv_title.setText(R.string.parse_json);
        ...
        // 获取显示数据的textView对象
        tv_native_orignal = findViewById(R.id.tv_native_orignal);
